...
* Từ`dict/34k.xyz.cdx` chuyển thành 4-grams (từ <= 4 âm tiết) và định danh phần còn lại của `u16` (sau khi đã trừ đi syllable ids và OOV BPE). Khởi tạo từ điển là một mapping 2 chiều từ `u16 <=> u64`
