...
# zig run telexify.zig -O ReleaseSafe -- input/VNESEcorpus.txt input/VNESEcorpus_tknz.txt

# zig run telexify.zig -O ReleaseSafe -- input/VNTQcorpus-big.txt input/VNTQcorpus_tknz.txt
